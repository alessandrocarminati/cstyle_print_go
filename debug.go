...
const DebugLevel uint32 = debugIO | (1<<debugDecorateFunctionName-1) | (1<<debugAddFunctionName-1)
...
func debugIOPrintln(a ...any) (int, error){
	 if DebugLevel & (1 << (debugIO-1)) != 0 {
		n, err := fmt.Println(a)
		return n, err
	}
...
func debugQueryPrintf(format string, a ...any) (int, error){
...
func debugQueryPrintln(a ...any) (int, error){
	 if DebugLevel & (1 << (debugQuery-1)) != 0 {
		n, err := fmt.Println(a)
		return n, err
	}
